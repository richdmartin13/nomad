class Sprite {
    ...
    draw(context, cameraMan) {
        const x = this.gameObject.posX - this.offset.x + utils.withGrid(12) - cameraMan.posX;
        const y = this.gameObject.posY - this.offset.y + utils.withGrid(14) - cameraMan.posY;
